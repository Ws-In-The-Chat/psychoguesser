...
(function () {
  const PSYCHOLOGISTS = [
    { id:'freud',     name:'Sigmund Freud',       short:'SF', color:'#8b5cf6', wiki:'Sigmund_Freud' },
    { id:'jung',      name:'Carl Jung',            short:'CJ', color:'#06b6d4', wiki:'Carl_Jung' },
    ...
    { id:'zimbardo',  name:'Philip Zimbardo',       short:'PZ', color:'#a855f7', wiki:'Philip_Zimbardo' },
    ...
    { id:'vygotsky',  name:'Lev Vygotsky',          short:'LV', color:'#6366f1', wiki:'Lev_Vygotsky' },
    ...
    { id:'harlow',    name:'Harry Harlow',          short:'HH', color:'#818cf8', wiki:'Harry_Harlow' },
    ...
    { id:'loftus',    name:'Elizabeth Loftus',      short:'EL', color:'#a78bfa', wiki:'Elizabeth_Loftus' },
    ...
    { id:'frankl',    name:'Viktor Frankl',         short:'VF', color:'#c4b5fd', wiki:'Viktor_Frankl' },
